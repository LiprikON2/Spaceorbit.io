import { type BaseScene, ClientScene } from "~/scenes/core";
...
export function MixinBaseMapScene<ClientOrServerScene extends Constructor<BaseScene>>(
...
export const BaseMapSceneClient = MixinBaseMapScene(ClientScene);
// export const BaseMapSceneServer = MixinBaseMapScene(ServerScene);
