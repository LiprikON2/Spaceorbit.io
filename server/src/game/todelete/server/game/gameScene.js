...
export class GameScene extends Scene {
    ...
    prepareToSync(player) {
        return `${player.playerId},${Math.round(player.x).toString(36)},${Math.round(
            player.y
        ).toString(36)},${player.dead === true ? 1 : 0},`;
    }
    ...
    create() {
        ...
        this.io.onConnection((channel) => {
            console.log("CONNECTION! AN ACTUAL CONNECTION");
            ...
            channel.on("addPlayer", (data) => {
                ...
                if (dead) {
                    ...
                    this.playersGroup.add(
                        new Player(this, channel.playerId, Phaser.Math.RND.integerInRange(100, 700))
                    );
                }
            });
